...
def patch_settings() -> None:
    ...
    group = {
        ...
        'settings': [
            ...
            {'type': 'text', 'id': 'es_mf_namespace', 'label': '元字段命名空间', 'default': 'custom'},
            {'type': 'text', 'id': 'es_deadline_key', 'label': '截至时间字段 Key', 'default': 'project_deadline'},
            {'type': 'text', 'id': 'es_desc_key', 'label': '卡片简介字段 Key', 'default': 'card_description'},
            {'type': 'text', 'id': 'es_author_key', 'label': '作者关联字段 Key', 'default': 'author'},
            {'type': 'text', 'id': 'es_tags_key', 'label': '卡片标签字段 Key', 'default': 'card_tags'},
            {'type': 'text', 'id': 'es_location_key', 'label': '地区字段 Key', 'default': 'card_location'},
